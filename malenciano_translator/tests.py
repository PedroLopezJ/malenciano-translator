...
class TestTraduction(unittest.TestCase):
    ...
    translator = Translator(castellan1)
    ...
    def testYaSeHaAcabadoPhrase(self):
        ...
        translator2 = Translator(castellan2)
    ...
    def testEstamosLocosPhrase(self):
        ...
        translator3 = Translator(castellan3)
    ...
    def testOlivasSinHueso(self):
        ...
        translator6 = Translator(castellan6)
    ...
    def testMeHasMatadoConEso(self):
        ...
        translator7 = Translator(castellan7)
    ...
    def testNotTranslateMention(self):
        ...
        translator8 = Translator(castellan8)
